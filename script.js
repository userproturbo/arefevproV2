...
var renderer, scene, camera, ww, wh, particles, imagedata, lastMousePos;
var projectReady = false;
var starsReady = false;
var portraitReady = false;
var animationReady = false;
var portraitCanvasWidth = 440;
var portraitCanvasHeight = 660;

ww = window.innerWidth, wh = window.innerHeight;

var centerVector = window.THREE ? new THREE.Vector3(0, 0, 0) : null;
var previousTime = 0;
var speed = 10;
var isMouseDown = false;

var startCanvasAnimations = function () {
	if (animationReady || !projectReady || !window.THREE || md && md.mobile && md.mobile()) return;
...
var getImageData = function (image) {
	...
	canvas.width = portraitCanvasWidth;
	canvas.height = portraitCanvasHeight;
...
image.onerror = function () {
	console.error('Failed to load portrait image:', "img/IMG_9939.png");
};
if (image.complete && image.naturalWidth) {
	portraitReady = true;
}
image.src = "img/IMG_9939.png";
var Submit = {
...
var md = window.MobileDetect ? new MobileDetect(window.navigator.userAgent) : { mobile: function () {
    return false;
  } };
